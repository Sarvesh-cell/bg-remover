      ...
      {isSignedIn ? (
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            ...
            className="flex items-center gap-2 bg-blue-200 px-4 sm:px-7 py-1.5 sm:py-2.5 rounded-full hover:scale-105 transition-all duration-500"
          >
          ...
          <p className="text-gray-500 max-sm:hidden">hello, {user.fullName}</p>
          <UserButton />
        </div>
      ) : (
        <button
